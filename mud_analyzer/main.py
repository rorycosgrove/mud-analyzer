...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        try:
            from mud_analyzer.menu import main as menu_main
            menu_main()
        except Exception as e:
    ...
    if command == "menu":
        ...
        try:
            from mud_analyzer.zone_browser_refactored import ZoneBrowser
            browser = ZoneBrowser()
            browser.main_menu()
        except Exception as e:
        ...
        try:
            from mud_analyzer.global_search_refactored import GlobalSearch
            search = GlobalSearch()
            search.main_menu()
        except Exception as e:
        ...
        try:
            from mud_analyzer.zone_explorer import main as explorer_main
